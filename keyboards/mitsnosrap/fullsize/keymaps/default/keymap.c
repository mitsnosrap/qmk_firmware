...
/*
 *     |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
 *     |--COL 0-|--COL 1-|--COL 2-|--COL 3-|--COL 4-|--COL 5-|--COL 6-|--COL 7-|--COL 8-|--COL 9-|-COL 10-|-COL 11-|-COL 12-|-COL 13-|-COL 14-|-COL 15-|-COL 16-|-COL 17-|-COL 18-|-COL 19-|-COL 20-|-COL 21-|
 *     |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
 */
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI,          KC_LALT,                   KC_SPC,                             KC_RALT, KC_RGUI,          KC_APP,  KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT,          KC_KP_0, KC_PDOT),
};
