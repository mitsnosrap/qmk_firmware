...
[_BL] = LAYOUT(
  ...
  KC_LCTL, KC_LALT, KC_LGUI, _______,          KC_SPC,  KC_SPC,                    _______, KC_RCTL, _______, MO(_FL), KC_LEFT, KC_DOWN, KC_RGHT),
...
[_FL] = LAYOUT(
  ...
  _______, _______, _______, _______,          _______, _______,                   _______, _______, MO(_ML), MO(_FL), KC_HOME, KC_VOLD, KC_END),

  /* Keymap _ML: Function Layer 2
   */
[_ML] = LAYOUT(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          M_ZVID,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   M_ZMUTE,
