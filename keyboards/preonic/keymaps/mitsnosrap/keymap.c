 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | F12  | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, M_GSTAT, M_GBRAN, M_GCHEC, M_GPULL, M_GPRUN, M_GDIFF, M_GCDEV, _______, _______, _______, _______, \
  _______, M_GSLIS, M_GSSHO, M_GSAPL, M_GSDRO, M_GSPUS, _______, _______, _______, KC_MRWD, KC_MPLY, KC_MFFD, \
  _______, M_ACFER, M_ACPAR, M_ACPRE, M_AOTLS, M_AOALS, M_AORLS, _______, _______, _______, _______, _______, \
